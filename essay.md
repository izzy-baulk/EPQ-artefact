...
I also decided at this point to create a custom GUI where a user could input the necessary data for the simulation to work, and choose whether to save the animation generated.
